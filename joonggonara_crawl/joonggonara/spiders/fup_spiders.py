...
BOARD_PAGE_URL = 'http://cafe.naver.com/ArticleList.nhn?search.boardtype=L&userDisplay=50&search.menuid=356&search.questionTab=A&search.clubid=10050146&search.specialmenutype=&search.totalCount=501&search.page=' # SKT - 339, KT - 424, LGT - 425, 여성상의(fup) - 356, 남성상의(mup) - 358
ARTICLE_URL = 'http://cafe.naver.com/ArticleRead.nhn?clubid=10050146&page=1&menuid=356&boardtype=L&articleid='

DATABASE_NAME = 'joonggonara.sqlite'
LIST_DB = 'list_fup'
DOWNLOADED_DB = 'downloaded_fup'

# 임시 변수
TARGET_FILE = 'target_fup.txt'
MAX_FILE = 'max_fup.txt'
LOGIN_FILE = 'output/login_fup.html'
ARTICLE_AHREF = '//a[contains(@href, "articleid") and not(contains(@href, "specialmenutype"))]/@href'
SAVE_LOCATION = 'output/fup/'
##### ##### ===== 프로젝트별 변수 끝 =====
