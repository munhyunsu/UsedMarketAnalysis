...
BOARD_PAGE_URL = 'http://market.ruliweb.daum.net/list.htm?table=market_xbox&find=&ftext=&ftext2=&ftext3=3&page='
ARTICLE_URL = 'http://market.ruliweb.daum.net/read.htm?table=market_xbox&page=&num='

DATABASE_NAME = 'ruliweb.sqlite'
LIST_DB = 'list_xbox'
DOWNLOADED_DB = 'downloaded_xbox'

# 임시 변수
TARGET_FILE = 'target_xbox.txt'
MAX_FILE = 'max_xbox.txt'
LOGIN_FILE = 'output/login_xbox.html'
ARTICLE_AHREF = '//a[contains(@href, "read.htm?table=market_xbox")]/@href'
SAVE_LOCATION = 'output/xbox/'
##### ##### ===== 프로젝트별 변수 끝 =====
