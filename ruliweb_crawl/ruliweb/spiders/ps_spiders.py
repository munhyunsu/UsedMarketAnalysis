...
BOARD_PAGE_URL = 'http://market.ruliweb.daum.net/list.htm?table=market_ps&find=&ftext=&ftext2=&ftext3=3&page='
ARTICLE_URL = 'http://market.ruliweb.daum.net/read.htm?table=market_ps&page=&num='

DATABASE_NAME = 'ruliweb.sqlite'
LIST_DB = 'list_ps'
DOWNLOADED_DB = 'downloaded_ps'

# 임시 변수
TARGET_FILE = 'target_ps.txt'
MAX_FILE = 'max_ps.txt'
LOGIN_FILE = 'output/login_ps.html'
ARTICLE_AHREF = '//a[contains(@href, "read.htm?table=market_ps")]/@href'
SAVE_LOCATION = 'output/ps/'
##### ##### ===== 프로젝트별 변수 끝 =====
