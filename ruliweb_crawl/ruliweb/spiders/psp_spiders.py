...
BOARD_PAGE_URL = 'http://market.ruliweb.daum.net/list.htm?table=market_psp&find=&ftext=&ftext2=&ftext3=3&page='
ARTICLE_URL = 'http://market.ruliweb.daum.net/read.htm?table=market_psp&page=&num='

DATABASE_NAME = 'ruliweb.sqlite'
LIST_DB = 'list_psp'
DOWNLOADED_DB = 'downloaded_psp'

# 임시 변수
TARGET_FILE = 'target_psp.txt'
MAX_FILE = 'max_psp.txt'
LOGIN_FILE = 'output/login_psp.html'
ARTICLE_AHREF = '//a[contains(@href, "read.htm?table=market_psp")]/@href'
SAVE_LOCATION = 'output/psp/'
##### ##### ===== 프로젝트별 변수 끝 =====
